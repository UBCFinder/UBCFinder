...
def detect():
	...
	if len(s2) > 0:
		...
		# 4、browser
		behavior41 = is_in_sentence(sen2, ["browser", "bookmark"])
		behavior42 = is_in_sentence(sen2, ["modify", "hijack"])
		...
		# 7、network traffic
		behavior71 = is_in_sentence(sen2, ["network", "traffic"])
		...
		# 11、powerboot
		behavior110 = is_in_sentence(sen2, ["powerboot"])
		if behavior110 == 1:
		...
		# 19、redirection
		behavior190 = is_in_sentence(sen2, ["redirect"])
		behavior191 = is_in_sentence(sen2, ["other"])
